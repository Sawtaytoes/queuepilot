...
//
// Regression this closes: the Python→Node port copied config.py's *placeholder defaults*
// verbatim but not its YAML layer, so under PLAYBACK_ENGINE=node every host value fell back
// to the non-routable placeholder — ADB dialed 192.0.2.30 and no profile-gated card played.
