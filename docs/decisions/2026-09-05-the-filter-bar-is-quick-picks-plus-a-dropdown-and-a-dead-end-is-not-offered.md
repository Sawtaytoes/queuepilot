...
> ones that aren't able to be clicked. For instance, if I click 'Alex', that's pretty much
> every queue, but if I click 'Morgan', there are some invalid combinations like Morgan and
> Piper. Piper should disable or disappear when she's been selected."
