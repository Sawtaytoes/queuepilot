...
>
> That way, selecting 'Rowan' or 'Callum' without selecting both will show the Halloween
...
> "it's weird that some folks don't show as having a queue such as my wife, Piper, etc when
