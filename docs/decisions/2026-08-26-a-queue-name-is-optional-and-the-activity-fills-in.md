...
> Webtoons. So I'd rename 'Alex - Movies' to just 'Movies'. I'd know whose it is by the fact
> that 'Alex' is the only one assigned to that particular 'Movies' queue."
...
- **The live queues still have to be renamed**, and that is DATA, not code. "Alex — Movies"
