...
That surfaced on 2026-08-26. The owner's own person row read `Alex`, and a *group* in the
same household is also labelled `Alex` — two different objects that the queue editor's trays
...
- The report, in full, with the screenshot of the trays showing the person `Alex Doyle`
  one card above the group `Alex` (chat 2026-08-26).
