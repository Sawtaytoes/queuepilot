...
//
// Run:  node e2e/collection-start-test.mjs   (from the repo root; non-zero on failure)
...
const items = (start) => resolve.collectionItems(client, CFG, 'Anything', new Set(), null, start);
